...
export const Histoire = ({ isActive, onToggle }: HistoireProps) => {
                        ...
                        <AnimatePresence mode="wait">
                            {!showContent ? (
                                ...
                                >
                                    ...
                                    >
                                        <span className="text-gray-600 text-[14px] font-medium">Cliquez pour découvrir</span>
                                        <motion.div
                                ...
                                >
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                    >
                                        <span className="relative z-10 aboreto-regular">Notre Histoire</span>
